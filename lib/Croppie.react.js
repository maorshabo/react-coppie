...
function (_React$Component) {
  ...
  function Croppie(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Croppie).call(this, props));
    ...
    _this.state = {};
    _this._bind = _this._bind.bind(_assertThisInitialized(_this));
    ...
    _this.keyMove = _this.keyMove.bind(_assertThisInitialized(_this));
    _this.changeZoom = _this.changeZoom.bind(_assertThisInitialized(_this));
    _this.mouseUp = _this.mouseUp.bind(_assertThisInitialized(_this));
    _this._updateOverlay = _this._updateOverlay.bind(_assertThisInitialized(_this));
    _this._setZoomerVal = _this._setZoomerVal.bind(_assertThisInitialized(_this));
    _this._onZoom = _this._onZoom.bind(_assertThisInitialized(_this));
    _this._getVirtualBoundaries = _this._getVirtualBoundaries.bind(_assertThisInitialized(_this));
    _this._updatePropertiesFromImage = _this._updatePropertiesFromImage.bind(_assertThisInitialized(_this));
    _this.preview = null;
    _this.viewport = null;
    _this.zoomer = null;
    _this.boundary = null;
  ...
  _createClass(Croppie, [{
    ...
    value: function render() {
      ...
      if (this.props.enableOrientation) {
        preview = _react["default"].createElement("canvas", {
          className: "cr-image",
      ...
      })), this.props.enableZoom && _react["default"].createElement("div", {
    ...
    value: function mouseDown(ev) {
      ...
      this.transform = _Transform["default"].parse(this.preview);
      window.addEventListener('mousemove', this.mouseMove);
      window.addEventListener('touchmove', this.mouseMove);
      window.addEventListener('mouseup', this.mouseUp);
      window.addEventListener('touchend', this.mouseUp);
      document.body.style[_styleStuff["default"].CSS_USERSELECT] = 'none';
    ...
    value: function keyDown(ev) {
      ...
      if (ev.shiftKey && (ev.keyCode == UP_ARROW || ev.keyCode == DOWN_ARROW)) {
        ...
        self.transform = _Transform["default"].parse(this.preview);
        document.body.style[_styleStuff["default"].CSS_USERSELECT] = 'none';
    ...
    value: function keyMove(movement) {
      ...
      newCss[_styleStuff["default"].CSS_TRANSFORM] = this.transform.toString(); // css(self.elements.preview, newCss);
      ...
      document.body.style[_styleStuff["default"].CSS_USERSELECT] = '';
    ...
    value: function changeZoom() {
      ...
      this._onZoom({
        ...
        transform: _Transform["default"].parse(this.preview)
      });
    }
  }, {
    key: "mouseUp",
    ...
    value: function _setZoomerVal(v) {
      ...
      if (this.props.enableZoom) {
        var z = _reactDom["default"].findDOMNode(this.zoomer);
    ...
    value: function _onZoom(ui) {
      var self = this;
      var transform = ui ? ui.transform : _Transform["default"].parse(_reactDom["default"].findDOMNode(this.preview));
      var //TODO does this need this.vpRect
      vpRect = ui ? ui.viewportRect : this.elements.viewport.getBoundingClientRect();
      var origin = ui ? ui.origin : new _helpers.TransformOrigin(_reactDom["default"].findDOMNode(this.preview));
      var transCss = {};

      function applyCss() {
        var transCss = {};
        transCss[_styleStuff["default"].CSS_TRANSFORM] = transform.toString();
        transCss[_styleStuff["default"].CSS_TRANS_ORG] = origin.toString();
        self.setState({
    ...
    value: function _bind(options) {
      ...
      if (typeof options === 'string') {
        ...
        //refreshing TODO
        this._updatePropertiesFromImage.call(this); // _triggerUpdate.call(self);TODO
      ...
      prom.then(function () {
        _this3._updatePropertiesFromImage.call(self); // _triggerUpdate.call(self);TODO
    ...
    value: function _updatePropertiesFromImage() {
      ...
      var transformReset = new _Transform["default"](0, 0, initialZoom);
      ...
      cssReset[_styleStuff["default"].CSS_TRANSFORM] = transformReset.toString();
      cssReset[_styleStuff["default"].CSS_TRANS_ORG] = originReset.toString();
      cssReset['opacity'] = 1;
      this.setState({
    ...
    value: function _centerImage() {
      ...
      var transform = new _Transform["default"](w, h, self._currentZoom); //css(self.elements.preview, CSS_TRANSFORM, transform.toString());

      var previewStyle = {};
      previewStyle[_styleStuff["default"].CSS_TRANSFORM] = transform.toString();
      this.setState({
    ...
    value: function _updateCenterPoint() {
      ...
      var transform = _Transform["default"].parse(this.preview.style[_styleStuff["default"].CSS_TRANSFORM]);
      ...
      transform.y -= adj.y;
      var newCss = {};
      newCss[_styleStuff["default"].CSS_TRANS_ORG] = center.x + 'px ' + center.y + 'px';
      newCss[_styleStuff["default"].CSS_TRANSFORM] = transform.toString(); //css(self.elements.preview, newCss);
...
Croppie.propTypes = {
  ...
  boundary: _propTypes["default"].object,
  orientationControls: _propTypes["default"].object,
  customClass: _propTypes["default"].string,
  showZoomer: _propTypes["default"].bool,
  enableZoom: _propTypes["default"].bool,
  mouseWheelZoom: _propTypes["default"].bool,
  enableExif: _propTypes["default"].bool,
  enforceBoundary: _propTypes["default"].bool,
  enableOrientation: _propTypes["default"].bool,
  update: _propTypes["default"].func,
  url: _propTypes["default"].string
};
var _default = Croppie;
